...
export default function ContributorSignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/auth/signup', {
        ...
        body: JSON.stringify({ name, email, password, userType: 'contributor' }),
      });
  ...
  const handleGoogleSignIn = async () => {
    await signIn('google', { redirectTo: '/join-workspace' });
  };
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div>
          ...
          <p className="text-center text-lg text-gray-600">
            Create your account to join a fellowship workspace
          </p>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="appearance-none relative block w-full px-4 py-3 border border-gray-300 rounded-lg placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent"
        ...
        <div className="text-center text-sm text-gray-600">
          <p>
            ...
            <Link href="/login" className="text-gray-900 underline font-medium">
              Sign in
            </Link>
          </p>
          <p className="mt-2">
            Not a contributor?{' '}
            <Link href="/signup" className="text-gray-900 underline font-medium">
              Sign up as admin
            </Link>
          </p>
        </div>
